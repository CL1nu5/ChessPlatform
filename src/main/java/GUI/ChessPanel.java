...
public class ChessPanel extends JPanel implements MouseListener, MouseMotionListener {
    ...
    private final Color SELECTED_PIECE_COLOR = new Color(19, 62, 135);
    private final Color MOVE_COLOR = new Color(37, 113, 128);
    private final Color CAPTURE_MOVE_COLOR = new Color(96, 139, 193);
